...
export default function Controls(p: ControlsProp) {
  ...
  return <>
      ...
      { open && <div id="toast-bottom-right" className={`z-50 fixed max-w-lg max-h-[calc(100vh-2rem)] flex items-center w-50 p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow right-10 ${p.pt?"top-32":"top-4"} dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800`} role="alert">
